...
## LAYER Dense 
model.add(LSTM(64, return_sequences=True, activation='relu', input_shape=(30,1662))) ##adicionar camada com 30 frames 1 segundo
...
#fit and train model
model.fit(X_train, Y_train, epochs=300, callbacks=[tb_callback]) ##avaliar epochs se esta muito alto para o numero de dados e avalisar loss + accuracy
